...
def evolve(robotType, typeString, folderString,p,envOrder,target):
	...
	evolver = afpo.Create(range(16),robotType, p,gens,steps,pop)
	...
	afpo.TestAllEnvs(evolver, range(16))

	print gensToTarget,  evolver['population'][0]['envError'], np.sum(gensToTarget)
...
#for i in range(50):
	#print i
	#NM1(p_nm1, [0,5,10,15], target = .05)
for i in range(50):
 	print i
 	NM1(p_nm1, [0,1,4,5])
 	#Modular(p_m1, [0,1,2,3])
 	#Modular(p_m1, [0,1,4,5])
