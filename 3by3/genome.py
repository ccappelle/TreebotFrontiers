...
def Create(myID,envList,robotType,p,steps):
	...
	g['Min_Case_Error'] = [0]*9
	g['Max_Case_Error'] = [0]*9
	...
	if (morphology == NM_MORPH):
		...
		#g['Min_Case_Error'] = [0.169, 0.1634, 0.1634,  0.287325]#0.3065705813877807]#[0.13, 0.151669, 0.151669, 0.367764]
	...
	if (morphology == MOD_MORPH):
		...
		g['U_min'] =  5.156854
		g['U_max'] = 5.315064
		#g['Min_Case_Error'] = [0.0,0.0411109,0.0411109,0.0822204]
		#g['Max_Case_Error'] = [0.0,  0.958891, 0.958891, 1.0]
